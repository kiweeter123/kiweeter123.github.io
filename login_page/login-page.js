...
loginButton.addEventListener("click", (e) => {
    ...
    if (username === "modz" && password === "cheeks") {
      ...
      if (username === "stin" && password === "cheeks") {
        ...
        window.location="https://kiwibrowser-c81090e51d00.com/verified.html"
    }
    ...
    if (username === "pilot" && password === "747") {
     ...
     if (username === "anni" && password === "cheeks") {
        alert("You have successfully logged in.");
        window.location="https://kiwibrowser-c81090e51d00.herokuapp.com/verified.html"
     }
    ...
    if (username === "pizza" && password === "cheeks") {
     ...
     if (username === "nelson" && password === "cheeks") {
        alert("You have successfully logged in.");
        window.location="https://kiwibrowser-c81090e51d00.herokuapp.com/verified.html"
    }
    ...
    if (username === "hinson" && password === "cheeks") {
        alert("You have successfully logged in.");
        window.location="https://kiwibrowser-c81090e51d00.herokuapp.com/verified.html"
    }
    ...
    if (username === "day" && password === "cheeks") {
        alert("You have successfully logged in.");
        window.location="https://kiwibrowser-c81090e51d00.herokuapp.com/verified.html"
    }
     ...
     if (username === "meri" && password === "cheeks") {
        alert("You have successfully logged in.");
        window.location="https://pkiwibrowser-c81090e51d00.herokuapp.com/verified.html"
    }
    ...
    if (username === "spangler" && password === "cheeks") {
        alert("You have successfully logged in.");
        window.location="https://kiwibrowser-c81090e51d00.herokuapp.com/verified.html"
    }
